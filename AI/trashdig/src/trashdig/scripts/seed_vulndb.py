...
from trashdig.agents.utils.helpers import load_prompt, print_model_info, run_agent
...
async def seed_vuln(
    ...
    Args:
        ...
        file_lock: Lock to protect shared metadata file.
    """
    ...
    # Save Markdown (Individual file is safe without lock)
    ...
    # Update metadata.json (Protected by lock)
...
async def main() -> None:
    ...
    tasks = [
        seed_vuln(agent, cwe, session_service, vulndb_dir, semaphore, file_lock)
